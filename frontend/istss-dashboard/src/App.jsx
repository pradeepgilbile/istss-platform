...
function LoginScreen({ onLogin, onRegister, onForgot }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #0a0e1a 0%, #111827 40%, #0f172a 100%)", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ width: 400, padding: 40, borderRadius: 16, background: "rgba(17,24,39,0.85)", border: "1px solid rgba(255,255,255,0.08)", backdropFilter: "blur(20px)" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{ fontSize: 40, marginBottom: 8 }}>🚦</div>
          <h1 style={{ color: "#f8fafc", fontSize: 20, fontWeight: 700, margin: "0 0 4px" }}>Smart Traffic Intelligence</h1>
...
function RegistrationScreen({ onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #0a0e1a 0%, #111827 40%, #0f172a 100%)", fontFamily: "'Inter', system-ui, sans-serif", padding: 20 }}>
...
export default function App() {
  ...
  const themeVars = dark
    ...
    : { "--bg": "#f8fafc", "--card": "#ffffff", "--border": "#e2e8f0", "--text": "#0f172a", "--muted": "#64748b", "--accent": "#2563eb" };
    ...
    <div style={{ ...themeVars, minHeight: "100vh", background: "var(--bg)", fontFamily: "'Inter', system-ui, sans-serif", display: "flex", color: "var(--text)" }}>
      ...
      <aside style={{ width: 220, background: "var(--card)", borderRight: "1px solid var(--border)", display: "flex", flexDirection: "column", flexShrink: 0, position: "sticky", top: 0, height: "100vh" }}>
        <div style={{ padding: "16px 16px 12px" }}>
          <div style={{ fontSize: 22, textAlign: "center", marginBottom: 4 }}>🚦</div>
