...
if(!token)return;
try{
const[s,c,d,v,n]=await Promise.all([api("/api/v1/dashboard/summary"),api("/api/v1/chowks"),api("/api/v1/devices"),api("/api/v1/violations"),api("/api/v1/notifications")]);
setSummary(s);setChowks(c.chowks||[]);setDevices(d.devices||[]);setViolations(v.violations||[]);setNotifs(n.notifications||[]);
...
const navItems=[{id:"dashboard",label:"Dashboard"},{id:"chowks",label:"Chowks"},{id:"devices",label:"Devices"},{id:"violations",label:"Violations"},{id:"notifications",label:"Notifications"}];
